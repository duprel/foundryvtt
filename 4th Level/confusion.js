(async () => {
    ...
    if (args[0] === "each") {
        ...
        await ChatMessage.create({ content: "Confusion roll for " + tactor.name + " is " + confusionRoll + ": " + content });
        ...
        if (saveRoll >= saveData.dc) {
            await ChatMessage.create({ content: "Confusion ends for " + tactor.name + " at the end of their turn" })
