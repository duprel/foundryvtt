...
let folder01 = "modules/jb2a_patreon/Library/Generic/Fireflies/";
//anFile is the name of the file used for the animation
let anFile = `${folder01}Fireflies_01_Red_Many02_400x400.webm`;
...
async function Cast() {
    ...
    for (var i = 0; i < arrayLength; i++) {
        ...
        let tarScale = ((mainTarget.data.width + mainTarget.data.height) / 5);
